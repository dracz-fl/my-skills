...
Turn the task into a verifiable goal before starting — usually a failing test
the change makes pass. State the plan and its verification steps.

## 4. Task Observer Activation
